...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const preloadImages = [
      {
        src: "assets/man.png",
        alt: "Man",
        position: { left: "45.1vw", top: "26.7vh" },
      ...
      },
      {
        ...
        alt: "Sleeve Right",
        position: { left: "43.5vw", top: "39.9vh" },
      ...
      },
      {
        ...
        alt: "Dress",
        position: { left: "49.2vw", top: "58.2vh" },
      ...
      },
      {
        ...
        alt: "Teddy",
        position: { left: "52.7vw", top: "22.7vh" },
      ...
      },
      {
        ...
        alt: "Sleeve Left",
        position: { left: "46.9vw", top: "35.9vh" },
      ...
      },
      {
        src: "assets/hat.png",
        alt: "Hat",
        position: { left: "52.1vw", top: "10.7vh" },
      ...
      },
      {
        ...
        alt: "Boots",
        position: { left: "48.3vw", top: "62.3vh" },
  ...
  clearAllButton.addEventListener("click", function () {
    ...
    if (collectionImages) {
      ...
      // Dispatch a custom event to notify generate-desc.js
      const clearCollectionEvent = new CustomEvent("clearCollection");
